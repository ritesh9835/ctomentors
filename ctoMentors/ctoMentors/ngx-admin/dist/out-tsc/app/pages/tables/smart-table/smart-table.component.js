...
var SmartTableComponent = /** @class */ (function () {
    function SmartTableComponent(http, _router, service) {
        this.http = http;
    ...
    SmartTableComponent.prototype.getValues = function () {
        var _this = this;
        this.service.getCityList().subscribe(function (data) { return _this.valList = data; });
    };
    ...
    SmartTableComponent = __decorate([
        ...
        __metadata("design:paramtypes", [http_1.Http, router_1.Router, smart_table_service_1.SmartTableService])
    ], SmartTableComponent);

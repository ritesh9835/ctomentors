...
var SmartTableService = /** @class */ (function () {
    ...
    SmartTableService.prototype.getCityList = function () {
        return this._http.get('https://localhost:44309/api/Test/Get/')
            .map(function (res) { return res.json(); })
            .catch(this.errorHandler);
    };
    SmartTableService.prototype.errorHandler = function (error) {
        console.log(error);
